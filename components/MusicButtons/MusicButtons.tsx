	 ...
	 viewBox="0 0 291.319 291.319">
            ...
            {links.youtubeMusic && 
                <a href={links.youtubeMusic}  className={classnames(styles.musicButton, styles.lottaText)} target='_blank'> 
                    ...
                    <span className={styles.buttonTitle}>YouTube Music</span> 
                </a> 
            }         
        </div>
    );
